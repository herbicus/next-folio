...
const Contact = () => {
  ...
  return (
    <Main meta={<Meta title="Contact" description="Herb Torres | Contact" />}>
      ...
      <div className="contact flex flex-col items-start justify-center h-full px-4 md:px-8 pt-10 md:pt-18 relative overflow-hidden">
        <img
        ...
        <div className="flex w-full max-w-screen-xl mx-auto relative z-10">
          <div className="contact-content text-white relative translate-x-[75px] md:translate-x-[100px]">
            <div className="absolute top-2/4 left-1/2 translate-x-[-50%] translate-y-[-50%] z-0 bg-black w-[250px] md:w-[300px] h-[250px] md:h-[300px] opacity-30 rotate-45 pointer-events-none"></div>
